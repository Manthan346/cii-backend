...
const PATHS = {
  ...
  /* ── Added: matches the icon names used by notificationTypeConfig.js.
     Some of these are plain aliases of glyphs that already existed under
     a different name (e.g. "briefcase" is identical to "jobs") — kept as
     separate keys so the notification config can use whichever semantic
     name reads better without you having to remember the internal alias. ── */
  briefcase:
    "M20 6h-2.18C17.4 4.84 16.3 4 15 4h-6C7.7 4 6.6 4.84 6.18 6H4C2.9 6 2 6.9 2 8v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-9 1h2v1h-2V7zm-1-2h4c.55 0 1 .45 1 1H9c0-.55.45-1 1-1zm10 15H4V8h16v12z",
  book: "M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",
  users:
