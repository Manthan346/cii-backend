...
const awards = [
  {
    year: "2023",
    title: "Best Skill Development Initiative",
    org: "FICCI Skill Awards",
  },
  {
    year: "2022",
    title: "National CSR Award – Education",
    org: "Ministry of Corporate Affairs",
  },
  {
    year: "2021",
    title: "Top Skill Training Organisation",
    org: "NSDC Recognition",
  },
  {
    year: "2020",
    title: "Excellence in Vocational Training",
    org: "CII National Awards",
  },
  {
    year: "2019",
    title: "Most Impactful NGO – Skills",
    org: "Times of India Awards",
  },
];
    ...
    <section className="sc-section" id="showcase">
      ...
      <div className="sc-achievements-block">
        ...
        <h2 className="sc-heading">
          Achievements & <span className="sc-accent">Milestones</span>
        </h2>
      ...
      <div className="sc-collab-block">
        ...
        <p className="sc-collab-sub">
          Trusted by India's leading corporations, government bodies, and sector
          skill councils
        </p>
          ...
          <div className="sc-ticker-track" ref={logoTrackRef}>
            {[...collaborators, ...collaborators].map((c, i) => (
              <div className="sc-collab-chip" key={i}>
                <div className="sc-collab-avatar" style={{ background: c.bg }}>
                  {c.initial}
                </div>
